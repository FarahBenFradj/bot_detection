...
DEFAULT_MODEL   = "deep_mlp"        # mlp | deep_mlp | attention | transformer
EPOCHS          = 100
BATCH_SIZE      = 64
LEARNING_RATE   = 1e-3
...
MODEL_TYPES = ["mlp", "deep_mlp", "attention", "transformer"]
...
# ── Streamlit app ─────────────────────────────────────────────────────────────
# Placeholder metrics shown in the sidebar (replace with real values after training)
MODEL_METRICS = {
